  ...
  const runSimulation = useCallback(async () => {
    ...
    try {
      ...
      const strategyParams: StrategyEngineParams = {
        ...
        // Pass through Rolling-Loan-specific fields so StrategyExecutionService can use them
      ...
      // Other strategies (default / ATH / movingAverage / athCollateral)
      // continue through the generic strategy execution engine.
